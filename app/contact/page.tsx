...
export default function ContactPage() {
  return (
    <div className="mx-auto max-w-5xl px-6 py-20 sm:px-8 sm:py-28">
      <Link
        href="/"
        className="mb-14 inline-flex items-center gap-2 text-xs font-semibold text-stone-500 hover:text-stone-900"
      >
      ...
      <h1 className="mt-5 max-w-4xl font-serif text-6xl leading-[.95] tracking-[-.04em] sm:text-8xl">
        We&apos;d love to <em className="font-normal text-[#a74735]">hear</em>{" "}
        from you.
      </h1>
      <div className="mt-14 grid gap-10 border-t border-stone-900/10 pt-10 md:grid-cols-2">
        <p className="text-xl leading-8 text-stone-700">
          Questions, ideas, or a story you want to share? Reach out — a real
          person reads every message.
        </p>
        <p className="text-sm leading-7 text-stone-500">
          We usually reply within two business days. For press or partnership
          enquiries, mention it in your message so we can route it to the right
          person.
        </p>
      </div>
