 ...
 * Matches the site's active 'Ocean' theme accent (see app/globals.css,
 * `[data-theme="ocean"]`), a blue palette chosen to meet WCAG AA contrast
 * for body text and interactive elements against both light and dark
 * surfaces.
 */
export const SITE_THEME_COLOR = '#28768e';
